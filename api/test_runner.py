import unittest
from tests import test_auth, test_auth_endpoint, test_snails_endpoint, test_races_endpoint, test_single_snail_endpoint, test_rounds_endpoint, test_single_race_endpoint
import xmlrunner
import sys
